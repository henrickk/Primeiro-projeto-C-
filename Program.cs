//Screen Sound
string mensagensDeBoasVindas = "Boas vindas ao Screen Sound";
...
void ExibirOpcoesDoMenu()
{
    ...
    Console.WriteLine("Digite 2 para mostrar todoas as brandas");
...
void MostrarBandasRegistradas ()
{
    ...
    Console.WriteLine("\nDigite uma tecla qualquer para voltar para o menu principal");
    Console.ReadKey();
    Console.Clear();
    ExibirOpcoesDoMenu();
}
...
void ExibirMedia()
{
    ...
    Console.Write("Digite o nome da banda que deseja exibir o nome da média: ");
    string nomeDaBanda = Console.ReadLine();
    if (bandasRegistradas.ContainsKey(nomeDaBanda))
    {
